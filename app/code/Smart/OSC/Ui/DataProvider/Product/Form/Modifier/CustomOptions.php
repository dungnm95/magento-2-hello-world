...
class CustomOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions
{
    ...
    const GRID_IMAGE_IMPORT_NAME = 'import_image';
    ...
    const GRID_TYPE_SELECT_NEW_NAME = 'values';
    /**#@-*/
    ...
    const FIELD_THUMB_COLOR = 'thumb_color';
    const FIELD_DISPLAY_MODE = 'display_mode';
    ...
    public function modifyData(array $data)
    {
        ...
        foreach ($productOptions as $index => $option) {
            ...
            foreach ($values as $value) {
                $pass_data = $value->getData();

                $options[$index][static::GRID_TYPE_SELECT_NEW_NAME][] = $this->formatPriceByPath(
                    ...
                    'children' => [
                        static::CONTAINER_OPTION => [
                            ...
                            'children' => [
                                ...
                                static::GRID_TYPE_SELECT_NEW_NAME => $this->getSelectTypeGridConfig(30)
                            ]
                        ],
                    ]
                ]
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
                        ...
                        static::FIELD_UPLOAD => $this->getUploadFieldConfig(60),
                        static::FIELD_THUMB_COLOR => $this->getThumbColorFieldConfig(70),
                        static::FIELD_DISPLAY_MODE => $this->getDisplayModeFieldConfig(80),
                        static::FIELD_IS_DEFAULT => $this->getIsDefaultFieldConfig(90),
                    ...
                    'config' => [
                        ...
                        'groupsConfig' => [
                            ...
                            'select' => [
                                ...
                                'indexes' => [
                                    static::GRID_TYPE_SELECT_NEW_NAME,
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'dataType' => Text::NAME,
                        'elementTmpl' => 'Smart_OSC/form/element/image-view',
                        'sortOrder' => $sortOrder,
                    ],
                ],
            ],
...
//                        'previewTmpl' => 'Smart_OSC/image-preview',
//                       'dataType' => Media::NAME,
//                        'sortOrder' => $sortOrder,
//                        'uploaderConfig' => [
//                            'url' => 'smart/option/upload'
//                        ]
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'componentType' => Field::NAME,
                        'formElement' => Select::NAME,
                        'dataScope' => static::FIELD_DISPLAY_MODE,
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                        'options' => [
